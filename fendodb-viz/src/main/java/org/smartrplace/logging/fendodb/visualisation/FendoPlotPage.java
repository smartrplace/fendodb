...
public class FendoPlotPage {

	public FendoPlotPage(final WidgetPage<?> page, final FendoDbFactory slotsDbFactory, final ApplicationManager appManager, final NameService nameService) {
...
//		final ScheduleViewerConfiguration svconfig = new ScheduleViewerConfiguration(false, true, false, null, false, 2 * 24 * 3600 * 1000L, 0L);
		...
		final ScheduleViewerBasic<FendoTimeSeries> dataPlot = new ScheduleViewerBasic<FendoTimeSeries>(page, "dataPlot", appManager,
					svconfig,new DefaultTimeSeriesDisplayTemplate<FendoTimeSeries>(nameService)) {
